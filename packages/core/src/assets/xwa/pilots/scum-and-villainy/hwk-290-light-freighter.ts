...
const t: ShipType = {
  ...
  icon: 'https://infinitearenas.com/xw2/images/shipicons/scum-and-villainy/I_HWK-290.png',
  pilots: [
    {
      name: 'Dace Bonearm',
    ...
    },
    {
      ...
      slots: ['Crew', 'Device', 'Illicit', 'Modification'],
      ffg: 177,
      standard: true,
      epic: true,
      keywords: ['Freighter'],
    ...
    },
    {
      xws: 'gamutkey',
      name: 'Gamut Key',
      caption: 'Collaborationist Gover- nor',
      cost: 5,
      initiative: 3,
      limited: 1,
      slots: [

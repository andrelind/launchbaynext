...
const t: ShipType = {
  ...
  ffg: 24,
  size: 'Large',
  dial: ['0OR', '1BB', '1FB', '1NB', '2TR', '2BW', '2FB', '2NW', '2YR', '3TW', '3BW', '3FB', '3NW', '3YW', '4FW'],
  ...
  pilots: [
    {
      ...
      slots: ['Talent', 'Cannon', 'Missile', 'Crew', 'Crew', 'Illicit', 'Modification', 'Title', 'Gunner'],
      ffg: 210,
      standard: true,
      epic: true,
      loadout: 16,
    ...
    },
    {
      ...
      slots: ['Talent', 'Cannon', 'Missile', 'Crew', 'Crew', 'Illicit', 'Modification', 'Gunner'],
      ffg: 211,
      standard: true,
      epic: true,
      keywords: ['Freighter'],
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/moraloeval.png',
    },
    {
    ...
    },
    {
      ...
      slots: ['Cannon', 'Missile', 'Crew', 'Crew', 'Gunner', 'Illicit', 'Illicit', 'Modification', 'Modification'],
      standard: true,
      extended: true,
      keywords: ['Freighter'],
      epic: true,
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/doctoraphra.png',
    },
    {
      name: 'Bossk',
      ...
      ability:
        'While you perform an attack, after the Neutralize Results step, you may spend 1 [crit] result to add 2 [hit] results.',
      shipAbility: {
      ...
      image: 'https://infinitearenas.com/xw2xwa/images/quickbuilds/bossk-armedanddangerous.png',
      slots: [],
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/bossk-armedanddangerous.png',
      standard: true,
      extended: true,
      keywords: ['Bounty Hunter', 'Freighter'],
      standardLoadout: ['embo-armedanddangerous', 'contrabandcybernetics', 'houndstooth-armedanddangerous'],
      epic: true,
    },
  ],
};

...
const t: ShipType = {
  ...
  icon: 'https://infinitearenas.com/xw2/images/shipicons/rebel-alliance/I_Falcon.png',
  pilots: [
    {
      name: 'Chewbacca',
      caption: 'The Mighty',
    ...
    },
    {
      ...
      slots: ['Crew', 'Missile', 'Gunner', 'Modification'],
      ffg: 72,
      standard: true,
      epic: true,
      loadout: 11,
    ...
    },
    {
      ...
      shipAbility: {
        name: 'High Stakes',
        text: 'After you perform a red action, you may roll an attack die. On a / result, remove 1 stress.',
      },
      standardLoadout: [

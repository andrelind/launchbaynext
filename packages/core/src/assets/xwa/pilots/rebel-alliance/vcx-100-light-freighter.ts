...
const t: ShipType = {
  ...
  icon: 'https://infinitearenas.com/xw2/images/shipicons/rebel-alliance/I_Ghost.png',
  pilots: [
    {
      name: '“Chopper”',
      caption: 'Spectre-3',
      ...
      slots: ['Crew', 'Crew', 'Sensor', 'Gunner', 'Turret', 'Modification', 'Torpedo', 'Title'],
      ffg: 75,
      standard: true,
      epic: true,
      loadout: 12,
    ...
    },
    {
      ...
      slots: ['Crew', 'Crew', 'Sensor', 'Gunner', 'Turret', 'Modification', 'Torpedo', 'Title', 'Talent', 'Talent'],
      ffg: 73,
      standard: false,
      epic: true,
      extended: true,
      keywords: ['Freighter', 'Spectre'],
      image: 'https://infinitearenas.com/xw2/images/pilots/herasyndulla-vcx100lightfreighter.png',
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/herasyndulla-vcx100lightfreighter.png',
    },
    {
      name: 'Hera Syndulla',
      caption: 'Legends and Relics',
      initiative: 6,
      limited: 1,
      cost: 18,
      loadout: 20,
      xws: 'herasyndulla-legendsandrelics',
      ability: 'After you fully execute a red maneuver, you may coordinate a friendly ship at range 0-3.',
      image: 'https://infinitearenas.com/xw2xwa/images/pilots/herasyndulla-legendsandrelics.png',
      slots: ['Crew', 'Crew', 'Sensor', 'Gunner', 'Turret', 'Modification', 'Torpedo', 'Title', 'Talent', 'Talent'],
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/herasyndulla-legendsandrelics.png',
      standard: true,
      extended: true,
      keywords: ['Freighter', 'Spectre'],
      epic: true,
    ...
    },
    {
      ...
      slots: ['Crew', 'Crew', 'Sensor', 'Gunner', 'Turret', 'Modification', 'Torpedo', 'Title', 'Force Power'],
      ffg: 74,
      standard: true,
      epic: true,
      loadout: 20,
    ...
    },
    {
      ...
      slots: ['Crew', 'Crew', 'Sensor', 'Gunner', 'Turret', 'Modification', 'Torpedo'],
      ffg: 76,
      standard: true,
      epic: true,
      keywords: ['Freighter'],
    ...
    },
    {
      ...
      standard: true,
      epic: true,
      slots: ['Crew', 'Crew', 'Sensor', 'Gunner', 'Turret', 'Modification', 'Torpedo', 'Title', 'Talent'],
      ability: 'While you defend, if the attacker modified any attack dice, you may roll 1 additional defense die.',
      cost: 17,
      ffg: 631,
      loadout: 14,
      extended: true,

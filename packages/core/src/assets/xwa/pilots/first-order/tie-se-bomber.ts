  ...
  pilots: [
    {
      ...
      standard: true,
      cost: 11,
      slots: ['Gunner', 'Modification', 'Tech', 'Device', 'Device', 'Missile', 'Talent', 'Torpedo'],
      ability:
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/breach.png',
    },
    {
      name: '“Scorch”',
      ...
      standard: true,
      cost: 10,
      slots: ['Gunner', 'Modification', 'Tech', 'Device', 'Device', 'Missile', 'Missile', 'Talent'],
      ability:
      ...
      loadout: 12,
      extended: true,
      image: 'https://infinitearenas.com/xw2/images/pilots/scorch_tiesebomber.png',
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/scorch-tiesebomber.png',
    },
    {
      name: '“Dread”',
      xws: 'dread',
      ...
      ability: 'After you reload, each ship in your [Bullseye Arc] gains 1 deplete token.',
      loadout: 9,
      extended: true,
    ...
    },
    {
      ...
      standard: true,
      cost: 10,
      slots: ['Gunner', 'Modification', 'Tech', 'Device', 'Device', 'Missile', 'Torpedo'],
      ability:
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/grudge.png',
    },
    {
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/firstordercadet.png',
      caption: '',
    },
    {
      ...
      standard: true,
      cost: 9,
      slots: ['Gunner', 'Modification', 'Tech', 'Device', 'Device', 'Missile', 'Missile'],
    ...
    },
    {
      ...
      loadout: 14,
      slots: ['Gunner', 'Modification', 'Tech', 'Device', 'Device', 'Missile', 'Talent', 'Torpedo'],
      ability: 'After you perform a [Boost] action, you may spend 1 [Charge] to remove 1 non-lock red or orange token.',
      charges: { value: 3, recovers: 0 },
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/juljerjerrod.png',

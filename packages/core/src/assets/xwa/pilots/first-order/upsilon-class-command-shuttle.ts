...
const t: ShipType = {
  ...
  pilots: [
    ...
    },
    {
      ...
      standardLoadout: [
        'generalhux-evacuationofdqar',
        'advancedsensors',
        'interferencearray-evacuationofdqar',
      ],
      image:
        'https://infinitearenas.com/xw2xwa/images/quickbuilds/pettyofficerthanisson-evacuationofdqar.png',
      artwork:
        'https://infinitearenas.com/xw2/images/artwork/pilots/pettyofficerthanisson-evacuationofdqar.png',
      standard: true,
      extended: true,
      epic: true,
    },

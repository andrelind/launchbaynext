...
const t: ShipType = {
  ...
  size: 'Huge',
  dial: ['0BR', '0OR', '0NR', '1BW', '1NW', '1FB', '2BR', '2NR', '2FB', '3FB', '4FR'],
  faction: 'First Order',
  stats: [
  ...
  pilots: [
    {
      ...
      epic: true,
      ffg: 712,
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/firstordersympathizers.png',
      image: 'https://infinitearenas.com/xw2/images/pilots/firstordersympathizers.png',
    },
    {
      name: 'Cerra Fellian',
      initiative: 0,
      ...
      loadout: 0,
      limited: 1,
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/cerrafellian-sl.png',
      image: 'https://infinitearenas.com/xw2/images/pilots/cerrafellian-sl.png',
      standard: true,
      extended: true,
      epic: true,
      engagement: 0,

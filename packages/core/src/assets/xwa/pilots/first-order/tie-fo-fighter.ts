  ...
  pilots: [
    {
      ...
      slots: ['Talent', 'Talent', 'Sensor', 'Modification', 'Modification', 'Tech', 'Missile'],
      ffg: 397,
      standard: true,
      epic: true,
      keywords: ['TIE'],
    ...
    },
    {
      ...
      slots: ['Talent', 'Talent', 'Sensor', 'Missile', 'Modification', 'Tech'],
    ...
    },
    {
      ...
      slots: ['Talent', 'Talent', 'Sensor', 'Modification', 'Tech', 'Missile],
      ffg: 398,
      standard: true,
      epic: true,
      keywords: ['TIE'],
    ...
    },
    {
      ...
      slots: ['Talent', 'Talent', 'Sensor', 'Modification', 'Tech'],
      ffg: 399,
      standard: true,
      epic: true,
      keywords: ['TIE'],
    ...
    },
    {
      ...
      slots: ['Talent', 'Talent', 'Sensor', 'Modification', 'Tech', 'Tech'],
      ffg: 402,
      standard: true,
      epic: true,
      keywords: ['TIE'],
    ...
    },
    {
      ...
      slots: ['Talent', 'Sensor', 'Tech', 'Tech', 'Cannon', 'Modification', 'Missile'],
      standard: true,
      extended: true,
      keywords: ['TIE'],
      epic: true,
    },
    {
      ...
      slots: ['Talent', 'Tech', 'Sensor', 'Modification'],
      standard: true,
      extended: true,
      keywords: ['TIE'],
      epic: true,
    ...
    },
    {
      ...
      standardLoadout: [
        ...
        'advancedwarningsystems-evacuationofdqar',
      ],
      standard: true,
      extended: true,
      keywords: ['TIE'],

...
const t: ShipType = {
  ...
  ability: {
    ...
    text: 'You can rotate your [Single Turret Arc] indicator only to your [Front Arc] or [Rear Arc]. You <strong>must</strong> treat the [Front Arc] requirement of your equipped [Missile] upgrades as [Single Turret Arc]',
  },
  pilots: [
    {
      name: 'Kylo Ren',
      ...
      standard: true,
      cost: 6,
      slots: ['Force Power', 'Force Power', 'Talent', 'Missile', 'Tech', 'Tech', 'Modification', 'Configuration'],
      ability:

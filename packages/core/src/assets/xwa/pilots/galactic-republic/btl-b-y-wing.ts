...
const t: ShipType = {
  ...
  xws: 'btlbywing',
  size: 'Small',
  dial: ['1BW', '1FB', '1NW', '2TW', '2BW', '2FB', '2NW', '2YW', '3TR', '3BW', '3FW', '3NW', '3YR', '4FR', '4KR'],
  ...
  pilots: [
    {
      ...
      standard: true,
      epic: true,
      slots: ['Turret', 'Torpedo', 'Astromech', 'Device', 'Modification'],
      cost: 3,
      ffg: 602,
      keywords: ['Clone', 'Y-wing'],
      loadout: 8,
      extended: true,
      image: 'https://infinitearenas.com/xw2/images/pilots/shadowsquadronveteran.png',
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/shadowsquadronveteran.png',
      caption: '',
    },
    {
      ...
      standard: true,
      epic: true,
      slots: ['Turret', 'Torpedo', 'Astromech', 'Device', 'Gunner', 'Force Power'],
      cost: 5,
      ffg: 596,
      ...
      image: 'https://infinitearenas.com/xw2/images/pilots/anakinskywalker-btlbywing.png',
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/anakinskywalker-btlbywing.png',
    },
    {
      name: 'R2-D2',
      xws: 'r2d2',
    ...
    },
    {
      ...
      standard: true,
      epic: true,
      slots: ['Talent', 'Turret', 'Torpedo', 'Torpedo', 'Astromech', 'Modification', 'Gunner'],
      cost: 4,
      loadout: 13,
      ffg: 597,
      keywords: ['Clone', 'Y-wing'],
      extended: true,
      image: 'https://infinitearenas.com/xw2/images/pilots/oddball-btlbywing.png',
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/oddball-btlbywing.png',
    },
    {
      name: '“Matchstick”',
      xws: 'matchstick',
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/matchstick.png',
    },
    {
      name: '“Broadside”',
      xws: 'broadside',
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/broadside.png',
    },
    {
      name: '“Goji”',
      xws: 'goji',
      ...
      standard: true,
      epic: true,
      slots: ['Talent', 'Turret', 'Astromech', 'Device', 'Device', 'Device', 'Modification', 'Gunner'],
      cost: 3,
      ffg: 601,
    ...
    },
    {
      ...
      standard: true,
      epic: true,
      slots: ['Turret', 'Torpedo', 'Astromech', 'Device'],
      cost: 3,
      ffg: 603,
      keywords: ['Clone', 'Y-wing'],
      loadout: 9,
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/redsquadronbomber.png',
      caption: '',
    },
  ],
  ffg: 68,

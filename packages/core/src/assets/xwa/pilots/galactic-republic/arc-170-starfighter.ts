...
const t: ShipType = {
  ...
  size: 'Medium',
  ffg: 31,
  dial: ['1BB', '1FB', '1NB', '2TW', '2BB', '2FB', '2NB', '2YW', '3TR', '3BW', '3FW', '3NW', '3YR', '4FR', '4KR'],
  ...
  pilots: [
    {
      ...
      slots: ['Talent', 'Torpedo', 'Crew', 'Astromech', 'Modification', 'Gunner', 'Gunner'],
      standard: true,
      epic: true,
      cost: 5,
      ffg: 526,
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/sinker.png',
    },
    {
      name: '“Jag”',
      xws: 'jag',
      cost: 5,
      slots: ['Torpedo', 'Astromech', 'Modification', 'Modification', 'Gunner', 'Gunner', 'Talent'],
      ffg: 525,
    ...
    },
    {
      ...
      cost: 5,
      slots: ['Talent', 'Sensor', 'Torpedo', 'Torpedo', 'Astromech', 'Modification', 'Gunner', 'Gunner'],
      ffg: 523,
      caption: 'CC-2237',
      initiative: 5,
      limited: 1,
      ...
      loadout: 17,
      extended: true,
      image: 'https://infinitearenas.com/xw2/images/pilots/oddball-arc170starfighter.png',
    ...
    },
    {
      ...
      xws: 'wolffe',
      cost: 4,
      slots: ['Talent', 'Torpedo', 'Astromech', 'Modification', 'Gunner', 'Crew'],
      ffg: 524,
      caption: 'CC-3636',
      initiative: 4,
      limited: 1,
    ...
    },
    {
      ...
      loadout: 13,
      extended: true,
      image: 'https://infinitearenas.com/xw2/images/pilots/104thbattalionpilot.png',
    ...
    },
    {
      ...
      cost: 4,
      slots: ['Talent', 'Astromech', 'Gunner', 'Gunner'],
      ffg: 527,
      initiative: 3,
      limited: 0,
      ...
      loadout: 5,
      extended: true,
      image: 'https://infinitearenas.com/xw2/images/pilots/squadsevenveteran.png',

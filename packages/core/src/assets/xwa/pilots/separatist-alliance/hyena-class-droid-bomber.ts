  ...
  pilots: [
    {
      ...
      epic: true,
      cost: 8,
      slots: ['Modification', 'Device', 'Configuration', 'Torpedo'],
      ffg: 568,
      keywords: ['Droid'],
      loadout: 12,
      extended: true,
    ...
    },
    {
      ...
      epic: true,
      cost: 9,
      slots: ['Modification', 'Device', 'Device'],
      ffg: 565,
      keywords: ['Droid'],
      loadout: 9,
      extended: true,
    ...
    },
    {
      ...
      epic: true,
      cost: 8,
      slots: ['Modification', 'Device', 'Configuration', 'Missile', 'Missile'],
      ffg: 566,
      keywords: ['Droid'],
      loadout: 10,
      extended: true,
    ...
    },
    {
      ...
      epic: true,
      cost: 9,
      slots: ['Modification', 'Device', 'Configuration', 'Missile'],
      ffg: 567,
      keywords: ['Droid'],
      loadout: 14,
      extended: true,

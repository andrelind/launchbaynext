  ...
  pilots: [
    {
      ...
      standard: true,
      epic: true,
      slots: ['Talent', 'Sensor', 'Modification', 'Modification', 'Missile', 'Cannon', 'Configuration'],
      cost: 10,
    ...
    },
    {
      ...
      standard: false,
      ability: "During the System Phase, you may spend your lock on a ship to look at that ship's dial.",
      slots: ['Talent', 'Sensor', 'Modification', 'Modification', 'Missile', 'Cannon', 'Configuration'],
      cost: 10,
      epic: true,
      ffg: 796,
    ...
    },
    {
      ...
      standard: true,
      ability: 'Setup: After placing forces, assign the Fearful Prey condition to 1 enemy ship.',
      slots: ['Talent', 'Sensor', 'Modification', 'Modification', 'Missile', 'Cannon', 'Configuration'],
    ...
    },
    {
      ...
      standard: true,
      slots: ['Sensor', 'Modification', 'Modification', 'Missile', 'Cannon', 'Configuration'],
      cost: 8,
      epic: true,
      ffg: 799,
      keywords: ['Droid'],
    ...
    },
    {
      ...
      slots: ['Talent', 'Sensor', 'Modification', 'Modification', 'Missile', 'Cannon', 'Illicit'],
    ...
    },
    {
      ...
      extended: true,
      ability:
        'At the start of the Engagement Phase, if there is an enemy ship in your [Bullseye Arc], you must spend 1 [Charge]. During the Engagement Phase, if your [Charge] is active, treat your initiative value as 1.',
      caption: 'Calculated Risk',
      cost: 11,
      loadout: 11,
      image: 'https://infinitearenas.com/xw2xwa/images/pilots/disl9b2-legendsandrelics.png',
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/disl9b2-legendsandrelics.png',
      slots: ['Talent', 'Sensor', 'Modification', 'Modification', 'Missile', 'Cannon', 'Configuration'],
      keywords: ['Droid'],
      epic: true,
      id: 422,

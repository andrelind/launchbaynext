...
const t: ShipType = {
  ...
  ffg: 20,
  size: 'Medium',
  dial: ['0OR', '1BB', '1FB', '1NB', '2TW', '2BW', '2FB', '2NW', '2YW', '3TR', '3BW', '3FW', '3NW', '3YR', '4KR'],
  ...
  pilots: [
    {
      ...
      slots: ['Talent', 'Sensor', 'Missile', 'Device', 'Device', 'Modification', 'Gunner'],
      ffg: 140,
      standard: false,
      epic: true,
      keywords: ['TIE'],
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/deathrain.png',
    },
    {
      name: '“Redline”',
      ...
      slots: ['Sensor', 'Torpedo', 'Missile', 'Missile', 'Device', 'Modification', 'Modification', 'Gunner'],
      ffg: 139,
      standard: false,
      epic: true,
      keywords: ['TIE'],
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/redline.png',
    },
    {
      ...
      slots: ['Sensor', 'Torpedo', 'Missile', 'Device', 'Modification', 'Gunner'],
      ffg: 141,
      standard: false,
      epic: true,
      keywords: ['TIE'],
      loadout: 13,
      extended: true,
      image: 'https://infinitearenas.com/xw2/images/pilots/cutlasssquadronpilot.png',
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/cutlasssquadronpilot.png',
      caption: '',
    },
  ],
};

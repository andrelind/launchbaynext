...
const t: ShipType = {
  ...
  icon: 'https://infinitearenas.com/xw2/images/shipicons/galactic-empire/I_Decimator.png',
  pilots: [
    {
      name: 'Captain Oicunn',
      ...
      slots: ['Talent', 'Talent', 'Torpedo', 'Crew', 'Crew', 'Device', 'Modification', 'Title', 'Gunner'],
      ffg: 146,
      standard: true,
      epic: true,
      loadout: 16,
    ...
    },
    {
      ...
      slots: ['Torpedo', 'Crew', 'Crew', 'Device', 'Modification', 'Gunner'],
      ffg: 148,
      standard: true,
      epic: true,
      loadout: 19,
    ...
    },
    {
      ...
      slots: ['Talent', 'Torpedo', 'Crew', 'Crew', 'Crew', 'Device', 'Modification', 'Title', 'Gunner'],
      ffg: 147,
      standard: true,
      epic: true,
      loadout: 10,

...
const t: ShipType = {
  ...
  pilots: [
    ...
    },
    {
      ...
      image:
        'https://infinitearenas.com/xw2xwa/images/pilots/carnorjax-legendsandrelics.png',
      slots: ['Force Power', 'Modification', 'Configuration'],
      artwork:
        'https://infinitearenas.com/xw2/images/artwork/pilots/carnorjax-legendsandrelics.png',
      standard: true,
      extended: true,
      keywords: ['TIE'],
      epic: true,

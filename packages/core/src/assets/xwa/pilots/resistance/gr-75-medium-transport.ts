...
const t: ShipType = {
  ...
  size: 'Huge',
  dial: ['0BR', '0OR', '0NR', '1BB', '1NB', '1FB', '2BW', '2NW', '2FW', '3FR', '4FR'],
  faction: 'Resistance',
  stats: [],
  actions: [],
  ability: {
  ...
  pilots: [
    {
      ...
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/newrepublicvolunteers.png',
      image: 'https://infinitearenas.com/xw2/images/pilots/newrepublicvolunteers.png',
    },
    {
      name: 'Oraf Desyk',
      initiative: 0,
      ...
      loadout: 0,
      limited: 1,
      artwork: 'https://infinitearenas.com/xw2/images/artwork/pilots/orafdesyk-epicsl.png',
      image: 'https://infinitearenas.com/xw2xwa/images/quickbuilds/orafdesyk-epicsl.png',
      standard: true,
      extended: true,
      epic: true,
      engagement: 0,

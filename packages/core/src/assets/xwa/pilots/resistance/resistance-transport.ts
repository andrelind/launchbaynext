...
const t: ShipType = {
  ...
  pilots: [
    ...
    },
    {
      ...
      slots: ['Sensor', 'Tech', 'Cannon', 'Cannon', 'Torpedo', 'Crew', 'Crew', 'Astromech', 'Modification'],
      cost: 4,
      ffg: 570,
      loadout: 17,
      extended: true,
    ...
    },
    {
      ...
      standardLoadout: ['forthecause-evacuationofdqar', 'R0-GR-evacuationofdqar', 'blacksquadronr4-evacuationofdqar'],

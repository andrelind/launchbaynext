...
const t: ShipType = {
  ...
  pilots: [
    ...
    },
    {
      ...
      standard: true,
      cost: 3,
      slots: ['Tech', 'Missile', 'Turret', 'Astromech', 'Device', 'Device', 'Modification', 'Modification'],
      text: '???',
      ffg: 905,
      epic: true,
    ...
    },
    {
      ...
      standard: true,
      cost: 3,
      slots: ['Tech', 'Turret', 'Astromech', 'Device', 'Modification', 'Modification'],
      ability:
    ...
    },
    {
      ...
      standard: true,
      cost: 3,
      slots: ['Tech', 'Turret', 'Missile', 'Astromech', 'Device', 'Modification', 'Modification'],
      ability:
    ...
    },
    {
      ...
      standard: true,
      cost: 3,
      slots: ['Tech', 'Turret', 'Astromech', 'Device', 'Modification', 'Modification', 'Illicit'],
      text: '???',
      ffg: 909,
      epic: true,
    ...
    },
    {
      ...
      loadout: 12,
      extended: true,
      image: 'https://infinitearenas.com/xw2/images/pilots/newrepublicpatrol.png',
    ...
    },
    {
      ...
      standard: true,
      cost: 3,
      slots: ['Tech', 'Turret', 'Astromech', 'Device', 'Modification', 'Illicit'],
      ...
      loadout: 8,
      extended: true,
      image: 'https://infinitearenas.com/xw2/images/pilots/kijimispicerunner.png',

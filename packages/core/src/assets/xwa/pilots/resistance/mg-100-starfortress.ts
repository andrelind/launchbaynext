...
const t: ShipType = {
  ...
  pilots: [
    ...
    },
    {
      ...
      standardLoadout: [
        'nixjerd-evacuationofdqar',
        'paigetico-evacuationofdqar',
        'protonbombs',
        'thermaldetonators',
      ],
      shipActions: [
      ...
      image:
        'https://infinitearenas.com/xw2xwa/images/quickbuilds/finchdallow-evacuationofdqar.png',
      artwork:
        'https://infinitearenas.com/xw2/images/artwork/pilots/finchdallow-evacuationofdqar.png',
      cost: 16,
      loadout: 0,
      standard: true,
      extended: true,
    ...
    },
    {
      ...
      standardLoadout: [
        'perceptivecopilot',
        'dedicatedgunners-evacuationofdqar',
        'protonbombs',
      ],
      standard: true,
      extended: true,

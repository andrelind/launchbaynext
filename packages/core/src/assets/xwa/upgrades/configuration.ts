    ...
    sides: [
      {
        ...
        slots: ['Configuration'],
        image:
          'https://infinitearenas.com/xw2/images/upgrades/graviticwell-legendsandrelics.png',
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/graviticwell-legendsandrelics.png',
      },
    ],
    cost: { value: 5 },
    ...
    sides: [
      {
        ...
        slots: ['Configuration'],
        image:
          'https://infinitearenas.com/xw2/images/upgrades/wingedreversal-legendsandrelics.png',
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/wingedreversal-legendsandrelics.png',
      },
    ],
    cost: { value: 0 },
    charges: { value: 2, recovers: 0 },

...
const t: UpgradeBase[] = [
    ...
    sides: [
      {
        ...
        slots: ['Tech'],
        image: 'https://infinitearenas.com/xw2/images/upgrades/advancedoptics.png',
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/advancedoptics.png',
        ffg: 460,
      },
    ],
    cost: { value: 5 },
    ...
    sides: [
      {
        ...
        slots: ['Tech'],
        image: 'https://infinitearenas.com/xw2/images/upgrades/ferrospherepaint.png',
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/ferrospherepaint.png',
        ffg: 488,
      },
    ],
    cost: { value: 4 },
    ...
    sides: [
      {
        ...
        slots: ['Tech'],
        image: 'https://infinitearenas.com/xw2/images/upgrades/hyperspacetrackingdata.png',
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/hyperspacetrackingdata.png',
        ffg: 461,
      },
    ],
    cost: { value: 15 },
    ...
    sides: [
      {
        ...
        image: 'https://infinitearenas.com/xw2/images/upgrades/primedthrusters.png',
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/primedthrusters.png',
        slots: ['Tech'],
        ffg: 463,
      },
    ],
    ...
    sides: [
      {
        ...
        image: 'https://infinitearenas.com/xw2/images/upgrades/targetingsynchronizer.png',
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/targetingsynchronizer.png',
        slots: ['Tech'],
        ffg: 464,
      },
    ],
    ...
    sides: [
      {
        ...
        slots: ['Tech'],
        image: 'https://infinitearenas.com/xw2/images/upgrades/patternanalyzer.png',
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/patternanalyzer.png',
        ffg: 462,
      },
    ],
    cost: { value: 5 },
    ...
    sides: [
      {
        ...
        slots: ['Tech'],
        image: 'https://infinitearenas.com/xw2/images/upgrades/biohexacryptcodes.png',
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/biohexacryptcodes.png',
        ffg: 491,
      },
    ],
    cost: { value: 2 },
    ...
    sides: [
      {
        ...
        type: 'Tech',
        slots: ['Tech'],
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/automatedtargetpriority.png',
        image: 'https://infinitearenas.com/xw2/images/upgrades/automatedtargetpriority.png',
        ability:
  ...
  },
  {
    ...
    sides: [
      {
        ...
        type: 'Tech',
        slots: ['Tech'],
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/sensorbuoysuite.png',
        image: 'https://infinitearenas.com/xw2/images/upgrades/sensorbuoysuite.png',
        ability:
    ...
    standard: true,
    epic: true,
    restrictions: [{ factions: ['firstorder'] }, { baseSizes: ['Medium', 'Large'] }],
    extended: true,
  },
  {
    limited: 0,
    ...
    sides: [
      {
        ...
        slots: ['Tech'],
        image: 'https://infinitearenas.com/xw2/images/upgrades/sensorscramblers.png',
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/sensorscramblers.png',
        ffg: 939,
      },
    ],
    cost: { value: 1 },
    restrictions: [{ chassis: ['tiewiwhispermodifiedinterceptor', 'tievnsilencer'] }],
    standard: true,
    epic: true,
    extended: true,
  },
    ...
    sides: [
      {
        ...
        type: 'Tech',
        ability: 'While you defend, if you are not stressed, you may reroll 1 [focus] result.',
        slots: ['Tech'],
      },
    ],
    standard: true,
    ...
    sides: [
      {
        ...
        type: 'Tech',
        ability: 'You can acquire locks beyond range 3. You cannot acquire locks at range 1.',
        slots: ['Tech'],
      },
    ],
    standard: true,
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          'While you perform a primary attack, if the defender does not have any green tokens, you may spend 1 [Charge] and 1 [Crit] result. If you do, add 2 [Hit] results.',
        charges: { value: 1, recovers: 0 },
        title: 'T-SJ1A Targeting Computer',
        type: 'Tech',
        slots: ['Tech'],
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/tsj1atargetingcomputer-legendsandrelics.png',
        image: 'https://infinitearenas.com/xw2/images/upgrades/tsj1atargetingcomputer-legendsandrelics.png',
      },
    ],
    restrictions: [{ factions: ['firstorder'] }],
    cost: { value: 4 },
    ...
    sides: [
      {
        ...
        type: 'Tech',
        ability:
          'After a friendly ship acquires a lock on an enemy ship at 0-1 of you, you may spend 1 [Charge] and gain 1 stress token. If you do, that friendly ship may gain 1 calculate token.',
        slots: ['Tech'],
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/targetingrelay-legendsandrelics.png',
        image: 'https://infinitearenas.com/xw2/images/upgrades/targetingrelay-legendsandrelics.png',
        charges: { value: 2, recovers: 0 },
      },
    ],
    cost: { value: 3 },

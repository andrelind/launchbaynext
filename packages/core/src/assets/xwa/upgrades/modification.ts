...
const t: UpgradeBase[] = [
  ...
  },
  {
    ...
    restrictions: [{ stat: { type: 'agility', value: 3 }, keywords: ['TIE'] }],
    cost: { value: 1 },
    extended: true,
  },
  {
    ...
    sides: [
      {
        ...
        type: 'Modification',
        ability:
          "After you fully execute a speed 3 turn ([Turn Left] or [Turn Right]), bank ([Bank Left] or [Bank Right]), Talon Roll ([Tallon Roll Left] or [Tallon Roll Right]), or Segnor's Loop ([Segnor's Loop Left] or [Segnor's Loop Right]) maneuver, you may spend 1 [Charge] to perform a [Barrel Roll] action, even while stressed.",
        slots: ['Modification'],
        charges: { value: 2, recovers: 0 },
        image: 'https://infinitearenas.com/xw2/images/upgrades/retrofittedautothrusters-legendsandrelics.png',
        artwork: 'https://infinitearenas.com/xw2/images/artwork/upgrades/retrofittedautothrusters-legendsandrelics.png',
      },
    ],
    cost: { value: 6 },
    restrictions: [{ baseSizes: ['Small'] }],

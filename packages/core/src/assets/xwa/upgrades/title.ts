...
const t: UpgradeBase[] = [
  ...
  },
  {
    ...
    limited: 1,
    xws: 'landosmillenniumfalcon-armedanddangerous',
    sides: [
      {
        title: "Lando's Millennium Falcon",
        type: 'Title',
        ability:
          'While you perform a primary attack, if the defender has a non-lock red or orange token, roll 1 additional attack die.',
        slots: ['Title'],
      },
    ],
    standard: true,
  ...
  },
  {
    name: "Hound's Tooth",
    limited: 1,
    xws: 'houndstooth-armedanddangerous',
    sides: [
      {
        title: "Hound's Tooth",
        type: 'Title',
        ability:
          'While you perform an attack, if you are reinforced and the defender is in the [Full Front Arc] or [Full Rear Arc] matching your reinforce token, you may change 1 of your [Focus] results to a [Hit] result. If the defender is stressed, you may change 1 of your %focus% results to a [Crit] result instead. ',
        slots: ['Title'],
      },
    ],
    standard: true,
  ...
  },
  {
    name: 'Xanadu Blood',
    limited: 1,
    xws: 'xanadublood-armedanddangerous',
    sides: [
      {
        title: 'Xanadu Blood',
        type: 'Title',
        ability:
          'After you decloak, you may choose an enemy ship in your [bullseye]. If you do, that ship gains 1 strain token.',
        slots: ['Title'],
      },
    ],
    standard: true,
  ...
  },
  {
    name: 'Mist Hunter',
    limited: 1,
    xws: 'misthunter-armedanddangerous',
    sides: [
      {
        title: 'Mist Hunter',
        type: 'Title',
        ability:
          'After you perform a [cannon] attack, you may gain 1 strain token to perform a bonus primary attack against the same target.',
        slots: ['Title'],
      },
    ],
    standard: true,
  ...
  },
  {
    name: 'Black One',
    limited: 1,
    xws: 'blackone-evacuationofdqar',
    sides: [
      {
        title: 'Black One',
        type: 'Title',
        ability:
          'After you perform a [slam] action, lose 1[charge]. If this upgrade has 0 active [charges], you cannot perform the [slam] action.',
        charges: { value: 2, recovers: 0 },
        slots: ['Title'],
      },
    ],

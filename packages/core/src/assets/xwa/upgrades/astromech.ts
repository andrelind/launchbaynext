...
const t: UpgradeBase[] = [
    ...
    sides: [
      {
        ...
        image:
          'https://infinitearenas.com/xw2/images/upgrades/modifiedr4punit.png',
        slots: ['Astromech'],
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/modifiedr4punit.png',
      },
    ],
    cost: { value: 5 },
    restrictions: [{ factions: ['rebelalliance'] }],
    ...
    sides: [
      {
        ...
        type: 'Astromech',
        ability:
          'While you perform a white [Barrel Roll] or [Boost] action, you may spend 1 [Charge]. If you do, treat the action as red and use a speed 2 template while performing the action.',
        slots: ['Astromech'],
        image:
          'https://infinitearenas.com/xw2/images/upgrades/r7t1-legendsandrelics.png',
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/r7t1-legendsandrelics.png',
      },
    ],
    restrictions: [
      {
  ...
  },
  {
    ...
    sides: [
      {
        title: 'Unhinged Astromech',
        type: 'Astromech',
        ability:
          'Decrease the difficulty of your speed 3 basic maneuvers ([Turn Left], [Bank Left], [Straight], [Bank Right], [Turn Right]).',
        slots: ['Astromech'],
        image:
          'https://infinitearenas.com/xw2/images/upgrades/r7t1-legendsandrelics.png',
        artwork:
    ...
    sides: [
      {
        ...
        charges: { value: 2, recovers: 0 },
        image:
          'https://infinitearenas.com/xw2/images/upgrades/flightassistastromech-legendsandrelics.png',
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/flightassistastromech-legendsandrelics.png',
      },
    ],
    restrictions: [{ baseSizes: ['Small'] }],
    cost: { value: 3 },

    ...
    sides: [
      {
        ...
        type: 'Talent',
        ability:
          'When you are destroyed, before you are removed, you may spend 1 [Charge] on an equipped [Device] upgrade to drop or launch a bomb using a speed 1 straight or bank ([Bank Left], [Straight], [Bank Right]) template.',
        slots: ['Talent'],
      },
    ],
    cost: { value: 2 },

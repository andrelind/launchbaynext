...
const t: UpgradeBase[] = [
  ...
  },
  {
    ...
    epic: true,
    restrictions: [
      { factions: ['galacticempire', 'firstorder', 'scumandvillainy'] },
    ],
    extended: true,
  },
  {
  ...
  },
  {
    ...
    standard: true,
    epic: true,
    restrictions: [{ factions: ['rebelalliance', 'scumandvillainy'] }],
    extended: true,
  },
  {
    xws: 'ursawren',
  ...
  },
  {
    ...
    standard: true,
    epic: true,
    restrictions: [{ factions: ['galacticrepublic', 'scumandvillainy'] }],
    extended: true,
  },
  {
    xws: 'ig11',
    ...
    sides: [
      {
        ...
        ffg: -1,
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/maul-crew.png',
  ...
  },
  {
    name: 'General Hux',
    limited: 1,
    xws: 'generalhux-evacuationofdqar',
    standardLoadoutOnly: true,
    sides: [
      {
        title: 'General Hux',
        ...
        slots: ['Crew'],
        ability:
          'General Hux: While you perform a white [coordinate] action, if you choose a friendly TIE/fo or TIE/sf, you may treat that action as red. If you do, coordinate up to 2 additional friendly TIE/fo or TIE/sf, and each ship you coordinate must perform the same action, treating it as red.',
      },
    ],
    standard: true,
    extended: true,
  ...
  {
    name: 'Nite Owl Sentries',
    limited: 1,
    xws: 'niteowlsentries-armedanddangerous',
    sides: [
      {
        ability:
          'During the System Phase, you may spend 3[charges]. At the end of the Activation Phase, if this upgrade has 0 active [charges], each enemy ship at range 0-1 of you rolls 1 attack die. On a [hit] or [crit] result it suffers a [hit]. [Keep those in two separate paragraphs]',
        title: 'Nite Owl Sentries',
        type: 'Crew',
        slots: ['Crew'],
        charges: { value: 3, recovers: 1 },
      },
  ...
  },
  {
    name: 'Embo',
    limited: 1,
    xws: 'embo-armedanddangerous',
    sides: [
      {
        ability:
          'At the start of the Engagement Phase, if there is an enemy ship at range 0, you may perform a red [Reinforce] action.',
        title: 'Embo',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  },
  {
    name: 'Todo 360',
    limited: 1,
    xws: 'todo360-armedanddangerous',
    sides: [
      {
        ability:
          'During the System Phase, you may spend 1 [charges]. If you do, you may remove 1 stress token to gain 1 strain token and 1 calculate token.',
        title: 'Todo 360',
        type: 'Crew',
        slots: ['Crew'],
        charges: { value: 2, recovers: 0 },
  ...
  },
  {
    name: '4-LOM',
    limited: 1,
    xws: '4lom-armedanddangerous',
    sides: [
      {
        ability:
          'At the start of the End Phase, you may spend 1 calculate token and choose an enemy ship at range 0-1. If you do, transfer 1 of your stress tokens to that ship.',
        title: '4-LOM',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  },
  {
    name: 'R0-GR',
    limited: 1,
    xws: 'r0gr-evacuationofdqar',
    sides: [
      {
        ability:
          'While you have 2 or fewer stress tokens, you may perform [coordinate] and [jam] actions, even while stressed. After you perform a [coordinate] or [jam] action, gain 1 calculate token.',
        title: 'R0-GR',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  },
  {
    name: 'Nix Jerd',
    limited: 1,
    xws: 'nixjerd-evacuationofdqar',
    sides: [
      {
        ability:
          'While you perform a [reload] action, you may spend 1 [charge] and gain 1 strain token. If you do, you may recover 1 additional [charge] on a [payload] upgrade.',
        title: 'Nix Jerd',
        charges: { value: 2, recovers: 0 },
        type: 'Crew',
        slots: ['Crew'],
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          'After a friendly ship at range 0-3 is destroyed, choose another friendly ship at range 0-3. That ship may perform a [Boost] or [Focus] action.',
        title: 'Leia Organa',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          'While you defend, you may gain 1 strain token. If you do, change 1 of your results to an [Evade] result.',
        title: 'C-3PO',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          'At the end of the Engagement Phase, if you are not shielded, you may roll 1 attack die to recover 1 [Shield]. If you do, on a [Hit] result, deal 1 facedown damage card to this ship.',
        title: 'R2-D2',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          'Before an enemy ship at range 0-3 reveals its dial, you may spend 1 [Charge] and choose a number. If the speed on the dial matches your choice, acquire a lock on that ship or recover 1 [Energy].',
        title: 'Thrawn',
        type: 'Crew',
        slots: ['Crew'],
        charges: { value: 1, recovers: 1 },
  ...
  {
    limited: 1,
    xws: 'azmorigan-epicsl',
    sides: [
      {
        ability:
          'After a friendly ship at range 0-3 is destroyed, before that ship is removed, you may equip an [Illicit] upgrade attached to that ship to this one. Recover all charges on it.',
        title: 'Azmorigan',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          'Bonus Attack: After performing a primary attack, you may spend 2 [Energy] and 1 [Charge] to perform a bonus primary attack against a different target.',
        title: 'Nien Nunb',
        type: 'Crew',
        slots: ['Crew'],
        charges: { value: 1, recovers: 1 },
  ...
  {
    limited: 1,
    xws: 'urcosfurdam-epicsl',
    sides: [
      {
        ability: 'After you perform a blue maneuver, recover 1 [Energy].',
        title: 'Urcos Furdam',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          "Setup: Before placing forces, you may spend 2 [Charge]. If you do, choose a friendly ship with a Wing Leader upgrade. Assign the It's the Resistance condition to it.",
        title: 'GA-75',
        type: 'Crew',
        slots: ['Crew'],
        charges: { value: 2, recovers: 1 },
  ...
  {
    limited: 1,
    xws: 'agentterex-epicsl',
    sides: [
      {
        ability:
          'After an enemy ship is destroyed during an attack, if the attacker is at range 1-2 of you, assign a focus token to them.',
        title: 'Agent Terex',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  {
    limited: 1,
    xws: 'protectorategleb-epicsl',
    sides: [
      {
        ability:
          'While you defend or perform an attack, during the Modify Dice step, another friendly ship at range 0-2 to you may gain a strain or deplete token. If they do, you may transfer one focus token from that ship to you.',
        title: 'Protectorate Gleb',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  {
    limited: 1,
    xws: 'bailorgana-epicsl',
    sides: [
      {
        ability:
          'At the start of the Engagement Phase, you may remove a green token from this ship. If you do, up to three other friendly ships at range 0-3 gain that token.',
        title: 'Bail Organa',
        type: 'Crew',
        slots: ['Crew'],
      },
  ...
  {
    limited: 1,
    xws: 'clonecommandercody-epicsl',
    sides: [
      {
        ability:
          'After you perform a [Single Turret Arc] attack that missed, if 1 or more [Hit]/[Critical Hit] results were neutralized, the defender gains 1 strain token.',
  ...
  {
    limited: 1,
    xws: 'ursawren-crew-rebel',
    sides: [
      {
        ability:
          'You can maintain up to 2 locks. Each lock must be on a different object. After a friendly ship at range 0-3 is locked by an enemy ship, you may perform a [Lock] action.',
        title: 'Ursa Wren',
        type: 'Crew',
        slots: ['Crew'],
        image: 'https://infinitearenas.com/xw2/images/upgrades/ursawren.png',
    ...
    sides: [
      {
        ...
        ability: 'Add [Illicit] slot.',
        slots: ['Crew', 'Crew'],
        force: { value: 1, recovers: 1, side: ['light', 'dark'] },
        grants: [
          { action: { type: 'Coordinate', difficulty: 'Purple' }, value: 1 },
          { slot: 'Illicit', value: 1 },
        ],
    ...
    sides: [
      {
        ...
        type: 'Crew',
        ability:
          'After you fully execute a maneuver, or perform a [Barrel Roll] or [Boost] action, you may spend 1 [Charge]. If you do, choose an enemy ship in your [Bullseye Arc]. That ship gains 1 strain token and you may acquire a lock on it.',
        slots: ['Crew'],
        charges: { value: 2, recovers: 0 },
        image:
          'https://infinitearenas.com/xw2/images/upgrades/fennecshand-legendsandrelics.png',
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/fennecshand-legendsandrelics.png',
      },
    ],
    cost: { value: 6 },
    restrictions: [{ factions: ['galacticempire'] }],
    ...
    sides: [
      {
        ...
        type: 'Crew',
        ability:
          'After a jammed enemy ship at range 1-2 removes a green token, you may spend 1 [Charge] to gain a matching token.',
        image:
          'https://infinitearenas.com/xw2/images/upgrades/zoriibliss-legendsandrelics.png',
        slots: ['Crew'],
        charges: { value: 1, recovers: 1 },
        grants: [{ action: { type: 'Jam', difficulty: 'White' }, value: 1 }],
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/zoriibliss-legendsandrelics.png',
      },
    ],
    cost: { value: 5 },
    restrictions: [{ action: { type: 'Jam' }, factions: ['resistance'] }],
    standard: true,
    extended: true,
    epic: true,
  },
    ...
    sides: [
      {
        ...
        type: 'Crew',
        ability:
          'While you perform a [Jam] or [Coordinate] action, you may spend 1 [Charge] to increase the range requirement for that action by 1. After you perform a [Jam] or [Coordinate] action, you may spend 2 [Charge] to perform a [Jam] or [Coordinate] action, treating it as red.',
        slots: ['Crew'],
        charges: { value: 1, recovers: 1 },
        image:
          'https://infinitearenas.com/xw2/images/upgrades/thrawn-legendsandrelics.png',
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/thrawn-legendsandrelics.png',
      },
    ],
    cost: { value: 6 },
    grants: [{ type: 'action', value: { type: 'Jam', difficulty: 'Red' } }],
    restrictions: [{ factions: ['galacticempire'] }],
    standard: true,
    extended: true,
    epic: true,
    ...
    sides: [
      {
        ...
        charges: { value: 1, recovers: 1 },
        image:
          'https://infinitearenas.com/xw2/images/upgrades/captive-legendsandrelics.png',
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/captive-legendsandrelics.png',
      },
    ],
    cost: { value: 8 },
    restrictions: [
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          'Before you activate, you may spend 1 [Force] to ignore obstacles until the end of this phase. If you do, and you move through an obstacle, you may acquire a lock on an enemy ship in your [Front Arc] at range 1',
        title: 'Ahsoka Tano',
        type: 'Crew',
        slots: ['Crew'],
        force: { value: 1, recovers: 1, side: ['light', 'dark'] },
        image:
          'https://infinitearenas.com/xw2/images/upgrades/ahsokatano-legendsandrelics.png',
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/ahsokatano-legendsandrelics.png',
      },
    ],
    cost: { value: 10 },
    restrictions: [{ factions: ['rebelalliance'] }],

...
const t: UpgradeBase[] = [
  ...
  },
  {
    ...
    limited: 0,
    xws: 'flechettecannons-armedanddangerous',
    sides: [
      {
        ability:
          'Attack: After this attack hits, if the defender is in your [bullseye], the defender gains 1 strain token.',
        title: 'Flechette Cannons',
        attack: {
          arc: 'Front Arc',
          value: 3,
          minrange: 2,
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          'Attack: If the defender is in your [Bullseye Arc], add 1 [Focus] result.',
        title: 'Precision-Tuned Cannons',
        type: 'Cannon',
        slots: ['Cannon'],
        attack: {
        ...
        artwork:
          'https://infinitearenas.com/xw2/images/artwork/upgrades/precisiontunedcannons-legendsandrelics.png',
        image:
          'https://infinitearenas.com/xw2/images/upgrades/precisiontunedcannons-legendsandrelics.png',
      },
    ],
    standard: true,
    extended: true,

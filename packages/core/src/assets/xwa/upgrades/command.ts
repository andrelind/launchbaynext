...
const t: UpgradeBase[] = [
  ...
  },
  {
    ...
    standard: false,
    epic: true,
    restrictions: [{ factions: ['Galactic Empire'] }, { chassis: ['tieadvancedx1', 'tieadvancedv1'] }],
    extended: false,
  },
  {
    limited: 1,
    ...
    standard: false,
    epic: true,
    restrictions: [{ factions: ['Scum and Villainy'] }, { baseSizes: ['Huge'] }],
    extended: false,
  },
  {
    limited: 1,
  ...
  },
  {
    ...
    standard: false,
    epic: true,
    restrictions: [{ factions: ['First Order'] }, { chassis: ['tiesffighter', 'tievnsilencer'] }],
    extended: false,
  },
  {
    limited: 1,
  ...
  },
  {
    ...
    cost: { value: 4 },
    restrictions: [{ factions: ['Galactic Republic'] }, { chassis: ['delta7aethersprite', 'eta2actis'] }],
    extended: false,
  },
  {
    xws: 'shadowwing',
  ...
  },
  {
    ...
    standard: false,
    epic: true,
    restrictions: [{ factions: ['Galactic Empire'] }, { chassis: ['tielnfighter', 'tieininterceptor'] }],
    extended: false,
  },
  {
    limited: 1,
  ...
  },
  {
    ...
    standard: false,
    epic: true,
    restrictions: [{ factions: ['Separatist Alliance'] }, { baseSizes: ['Huge'] }],
    extended: false,
  },
  {
    xws: 'rifftamson',
  ...
  },
  {
    ...
    cost: { value: 1 },
    restrictions: [{ factions: ['Scum and Villainy'] }, { 'non-limited': false }],
    epic: true,
    extended: false,
    standarized: true,
  },
  ...
  },
  {
    ...
    cost: { value: 6 },
    restrictions: [{ factions: ['Separatist Alliance', 'Scum and Villainy'] }, { baseSizes: ['Huge'] }],
  },
  {
    limited: 1,
  ...
  },
  {
    ...
    cost: { value: 5 },
    restrictions: [{ baseSizes: ['Huge'] }, { factions: ['Separatist Alliance'] }],
  },
  {
    limited: 1,
    ...
    cost: { value: 5 },
    restrictions: [{ factions: ['Rebel Alliance'] }, { baseSizes: ['Small', 'Medium', 'Large'] }],
  },
];

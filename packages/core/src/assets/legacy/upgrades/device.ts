...
const t: UpgradeBase[] = [
    ...
    sides: [
      {
        ...
        type: 'Device',
        ability:
          'During the System Phase, you may spend 1 [Charge] to drop a Bomblet with the [1 [Straight]] template. At the start of the Activation Phase, you may spend 1 shield to recover 2 [Charge].',
        slots: ['Device', 'Device'],
    ...
    sides: [
      {
        ...
        type: 'Device',
        ability:
          "During the System Phase, you may spend 1 [Charge] to drop a Conner Net using the [1 [Straight]] template. This card's [Charge] cannot be recovered.",
        slots: ['Device'],
        charges: { value: 1, recovers: 0 },
        device: {
          name: 'Conner Net',
    ...
    sides: [
      {
        ...
        type: 'Device',
        ability:
          "During the System Phase, you may spend 1 [Charge] to drop a Proximity Mine using the [1 [Straight]] template. This card's [Charge] cannot be recovered.",
        slots: ['Device'],
        charges: { value: 2, recovers: 0 },
        device: {
          name: 'Proximity Mine',
    ...
    sides: [
      {
        ...
        device: {
          ...
          image:
            'https://infinitearenas.com/xw2/images/remotes/drk1probedroid.png',
        },
      },
    ],
    cost: { value: 5 },
  ...
  },
  {
    ...
    sides: [
      {
        ability:
          'During the System Phase, you may spend up to 2 [Charge] to drop that many Thermal Detonators using the [1 [Straight]] or [2 [Straight]] template. Each must be placed using a different template. When you reload this card, recover 1 additional [Charge].',
        ...
        device: {
          ...
          type: 'Bomb',
          effect:
            'At the end of the Activation Phase, this device detonates. When this device detonates, each ship and remote at range 0–1 rolls 1 attack die. Each ship gains 1 strain token for each [Focus] result, and each ship and remote suffers 1 [Hit]/[Crit] damage for each matching result.',
        },
      },
    ],
    cost: { value: 5 },

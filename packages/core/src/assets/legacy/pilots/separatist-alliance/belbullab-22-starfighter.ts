...
const t: ShipType = {
  ...
  pilots: [
    ...
    {
      name: 'Hallio Bas',
      caption: 'Skakoan Guide',
      initiative: 5,
      limited: 1,
      xws: 'halliobas-wat1',
      ability:
        'While you defend or perform an attack, before attack dice are rolled, if there are no other friendly ships at range 0-1, you may spend 1 [Charge] to remove 1 red or orange token.',

...
const t: ShipType = {
  ...
  pilots: [
    ...
    },
    {
      ...
      cost: 27,
      ability:
        'While a friendly ship at range 0-3 exposes a damage card, you may gain 1 deplete or stress token. If you do, that card is flipped facedown instead of resolving its effects. While you remove 1 or more red tokens, remove 1 additional token of the same type.',
      caption: 'Daughter of the Resistance',
      artwork:
        'https://raw.githubusercontent.com/SogeMoge/x-wing2.0-project-goldenrod/2.0-legacy/src/images/Art/pilots/torradoza-wat1.png',
      image:
        'https://raw.githubusercontent.com/SogeMoge/x-wing2.0-project-goldenrod/2.0-legacy/src/images/En/pilots/torradoza-wat1.png',
      epic: true,
      extended: true,
      ffg: 1177,
    },

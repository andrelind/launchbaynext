...
import { SortSquadronsSheetProps, SortSquadronsSheetReturn } from './sortSquadrons';
...
declare module 'react-native-actions-sheet' {
  interface Sheets {
    ...
    SortSquadronsSheet: SheetDefinition<{
      payload: SortSquadronsSheetProps;
      returnValue: SortSquadronsSheetReturn;
    }>;

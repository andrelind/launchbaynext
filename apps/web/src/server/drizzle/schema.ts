import { pgTable, foreignKey, uuid, text, timestamp, boolean, jsonb, integer } from "drizzle-orm/pg-core"
...
export const Games = pgTable("Games", {
	Id: uuid("Id").primaryKey().notNull(),
	TournamentId: uuid("TournamentId").notNull().references(() => Tournaments.Id),

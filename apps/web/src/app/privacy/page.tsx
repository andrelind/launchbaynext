    ...
    <div className="m-10 text-gray-500">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Launch Bay Next.
            </p>
          </li>
          <li>
      ...
      <div className="mb-10">
        ...
        <p>
          ...
          <p>
            ...
            mobile device when You go offline,&nbsp;
            <span className="text-lbn-500">
          ...
          <ul>
            ...
            <li>
              while Session Cookies are deleted as soon as You close your web
              browser. Learn more about cookies here:{' '}
              <a href="https://www.freeprivacypolicy.com/blog/cookies/">
                Cookies: What Do They Do?
              </a>
            </li>
      ...
      <ul>
        ...
        <li>
          ...
          such as a mobile application&rsquo;s push notifications regarding
      ...
      <p>
        If you would like to have your personal data removed, please contact us

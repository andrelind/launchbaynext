...
export const ShipTypeComponent: FC<Props> = ({ shipType, showFaction }) => (
  <div className="flex flex-1 flex-col m-2">
    <SlimShip shipType={shipType} showFaction={showFaction} />
    ...
    <div className="flex flex-row items-center hidden sm:block">
      <div className="flex flex-1 flex-col sm:flex-row justify-between">
        ...
        {shipType && <ActionsComponent actions={shipType?.actions} vertical />}
      </div>
    </div>
